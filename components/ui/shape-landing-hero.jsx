                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <h1
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-6xl  text-transparent bg-gradient-to-r from-indigo-300 via-white/90 to-rose-300 "
                                )}>
                                {title2}
                            </span>
                        </h1>
                    ...
                    <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <p
                            ...
                            Hi, I’m Shriram — a tech enthusiast with a love for problem-solving and innovation. Whether it’s developing real-time apps, tackling complex algorithms, or exploring new technologies, I aim to push boundaries and build products that make a difference.
                        </p>
                    </motion.div>
                </div>
            </div>
